...
SOURCES   += configuration.cpp MainWindow.cpp rpiConfigurator.cpp servicemonitorconfiguration.cpp
HEADERS   += configuration.h MainWindow.h servicemonitorconfiguration.h
FORMS     += MainWindow.ui
RESOURCES += 
