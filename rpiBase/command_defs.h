...
namespace rpi
{
    // command senders ranging from 0x00010000 - 0x0FFF0000 => 4095 possible command senders
    const int CMD_SENDER_TARGET_BROADCAST = 0x00000000;
    const int CMD_SENDER_TARGET_MONITOR = 0x00010000;
    const int CMD_SENDER_TARGET_CONTROLLER = 0x00020000;
